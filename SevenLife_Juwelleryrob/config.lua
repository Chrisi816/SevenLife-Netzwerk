...
Config.jewelsstart = 6

Config.jewelsend = 15

Config.enablejuwellery = true

Config.kleidungsshop = true

Config.isabagneeded = true

Config.activemarkers = true

Config.enablejuwelleryblip = true

Config.vetrienen = 15

Config.seller = true

Config.juwelleryblip = {
    x = -628.25,
    y = -235.18
}
