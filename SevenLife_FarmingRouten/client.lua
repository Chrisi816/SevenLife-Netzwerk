...
Citizen.CreateThread(
    function()
        Citizen.Wait(1000)
        CreateBlip(
            SevenConfig.LocationBaumark.x,
            SevenConfig.LocationBaumark.y,
            SevenConfig.LocationBaumark.z,
            "Baumarkt",
            566,
            61
        )
...
function SpawnNPC()
    ...
    for i = 1, pednumber do
        local NpcSpawner =
            vector3(SevenConfig.LocationBaumark.x, SevenConfig.LocationBaumark.y, SevenConfig.LocationBaumark.z)
        ...
        if not HasModelLoaded(ped) then
            ...
            ped1 =
                ...
                NpcSpawner.y,
                NpcSpawner.z,
                SevenConfig.LocationBaumark.heading,
                false,
                true
            )
    ...
    function()
        while true do
            ...
            local distance =
                GetDistanceBetweenCoords(
                PlayerCoord,
                SevenConfig.NPCBaumarkt.x,
                SevenConfig.NPCBaumarkt.y,
                SevenConfig.NPCBaumarkt.z,
                true
            )
            ...
            if distance < 40 then
                ...
                if not pedloaded then
                    ...
                    ped1 =
                        ...
                        SevenConfig.NPCBaumarkt.y,
                        SevenConfig.NPCBaumarkt.z,
                        SevenConfig.NPCBaumarkt.heading,
                        false,
                        true
                    )
                    SetEntityInvincible(ped1, true)
