    ...
    function()
        while true do
            ...
            local distance =
                ...
                PlayerCoord,
                Config.DrogenRouten.WeedEnde.x,
                Config.DrogenRouten.WeedEnde.y,
                Config.DrogenRouten.WeedEnde.z,
                true
            )
            ...
            if distance < 30 then
                ...
                if not pedloaded then
                    ...
                    ped1 =
                        ...
                        Config.DrogenRouten.WeedEnde.y,
                        Config.DrogenRouten.WeedEnde.z,
                        Config.DrogenRouten.WeedEnde.heading,
                        false,
                        true
                    )
                ...
                if distance < 2 then
                    ...
                    if notifys then
                        TriggerEvent(
                            ...
                            "Drücke <span1 color = white>E</span1> um 1 Packung Weed zu verkaufen",
                            "System - Nachricht",
                            true
                        )
                    end
                            ...
                            function(count)
                                ...
                                if count >= 1 then
                                    ...
                                    Citizen.CreateThread(
                                        function()
                                            Citizen.Wait(11000)
                                            TriggerServerEvent("SevenLife:Weed:GiveGeld")
                                            inmenu = false
                                            notifys = true
                                        end
                                    )
                                    ...
                                    TriggerEvent(
                                        ...
                                        "Meth Verkäufer",
                                        "Du hast zu wenig Weed packungen",
                                        2000
                                    )
                                end
                            end,
