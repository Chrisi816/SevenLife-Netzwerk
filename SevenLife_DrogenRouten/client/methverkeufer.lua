            ...
            if distance < 30 then
                ...
                if not pedloaded then
                    ...
                    ped1 =
                        ...
                        Config.DrogenRouten.MethEnde.y,
                        Config.DrogenRouten.MethEnde.z,
                        Config.DrogenRouten.MethEnde.heading,
                        false,
                        true
                    )
                ...
                if distance < 2 then
                    ...
                    if notifys then
                        TriggerEvent(
                            ...
                            "Drücke <span1 color = white>E</span1> um 1 Packung Meth zu verkaufen",
                            "System - Nachricht",
                            true
                        )
                    end
                            ...
                            function(count)
                                ...
                                if count >= 1 then
                                    ...
                                    Citizen.CreateThread(
                                        function()
                                            Citizen.Wait(11000)
                                            TriggerServerEvent("SevenLife:Meth:GiveGeld")
                                            inmenu = false
                                            notifys = true
                                        end
                                    )
                                    ...
                                    TriggerEvent(
                                        ...
                                        "Meth Verkäufer",
                                        "Du hast zu wenig Meth packungen",
                                        2000
                                    )
                                end
                            end,
