    ...
    function()
        while true do
            ...
            local distance =
                ...
                coords,
                Config.VerarbeiterCoords.Tisch1Weed.x,
                Config.VerarbeiterCoords.Tisch1Weed.y,
                Config.VerarbeiterCoords.Tisch1Weed.z,
                true
            )
            if distance < 15 then
                area = true
                ...
                if distance < 1.1 then
                    ...
                    if activenotify then
                        TriggerEvent(
                            ...
                            "Drücke E um das Weed zu Strecken",
                            "System - Nachricht",
                            true
                        )
                    end
        ...
        while true do
                                    ...
                                    ESX.TriggerServerCallback(
                                        ...
                                        function(canPickUp)
                                            if canPickUp then
                                                ...
                                                times = 1
                                                TriggerServerEvent("SevenLife:Weed:RemoveItem", "weed", 3)
                                                SendNUIMessage(
                                                    {
            ...
            if active then
                if IsControlJustPressed(0, 38) then
                    SendNUIMessage(
                        {
                            type = "OpenBarVerarbeitenManuellUpdate"
                        }
                    )
                end
            end
...
RegisterNUICallback(
    ...
    function()
        ...
        times = 5
        activenotify = true
        TriggerServerEvent("SevenLife:Weed:ChangeItem")
    end
)
