...
Citizen.CreateThread(
    function()
        while true do
            ...
            local distance =
                GetDistanceBetweenCoords(coords, Config.Meth.GetIn.x, Config.Meth.GetIn.y, Config.Meth.GetIn.z, true)
            if distance < 15 then
                area = true
                timemain = 15
                if distance < 1.1 then
                    ...
                    if activenotify then
                        TriggerEvent(
                            ...
                            "Drücke E um ins Methamphetamin Labor zu kommen",
                            "System - Nachricht",
                            true
                        )
                    end
        ...
        while true do
            ...
            if inmarker then
                if IsControlJustPressed(0, 38) then
                    ...
                    inmarker = false
                    RequestCollisionAtCoord(996.85809326172, -3200.7270507813, -37.393730163574)
